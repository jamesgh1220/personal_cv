<template>
  <ul class="space-y-6 lg:flex lg:gap-10 lg:space-y-0 pb-20">
    <li class="space-y-2 lg:p-4 lg:flex-1 lg:rounded-2xl lg:inset-shadow-sm">
...
<script setup>
import { CodeXml, Rocket, Zap, Users } from "lucide-vue-next";
</script>
